...
project_root_abs   = $(CURDIR)
project_root_rel   = $(notdir $(project_root_abs))

# PREPARE : set target directory
project_root_target = $(basedir)/amk/$(build_cfg_target)
...
prepare:
	...
	@echo "build_dir_target        : $(project_root_target)/$(build_cfg_target)"
	@echo "----------------------------------------------------------------"
