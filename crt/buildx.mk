...
module_build_src_ex    = 
module_build_cflags    = -I$(current_dir_abs)/include -D_SYSCRT=1 -DCRTDLL=1 -D_CRTBLD 
module_build_ldflags   = 
module_build_target_a  = $(build_opt_a_pre)crt.$(build_opt_a_ext)

# PREPARE : Set VPATH!!
vpath %.c $(current_dir_abs)/src

# PREPARE : Build Targets
module_objs_static     = $(patsubst %.c,%.o,$(module_build_src_mk))
...
all: prepare $(module_target_static) post
